          ...
          <div className="col col--8 col--offset-2">
            <div className="text--center">
              <Heading as="h1" className={styles.heroTitle}>
                About Average Joes Lab
              </Heading>
              <p className={styles.heroSubtitle}>
                Democratizing research and empowering citizen researchers to contribute to human knowledge
              </p>
            </div>
          </div>
        </div>
    ...
    <section className={styles.valuesSection}>
      <div className="container">
        <div className="text--center margin-bottom--xl">
          <Heading as="h2" className="text-gradient" id="mission">
            Our Mission & Values
          </Heading>
...
export default function About(): ReactNode {
  ...
  return (
    <Layout
      title="About Us"
      description="Learn about Average Joes Lab's mission to democratize research and empower citizen researchers to contribute to human knowledge.">
      <AboutHero />
      <main>
        <FounderStory />
        <MissionValues />
